# 💬 Conversational Prompt Templates Guide
...
## 3. Strategic AI Reasoning (Rationale Engine)
* **Macro Catalyst Matching**:
  > *"Trigger the `rationale-engine` to explain why the manager increased ExxonMobil (XOM) in `berkshire_hathaway_holdings.json`, correlating the trade with a 5.5% Fed Funds rate pause, sticky CPI, and an inverted yield curve."*
...
## 5. Dual-Manager Contrasting (Institution Comparison Engine)
...
👉 Next: **[Core Financial Infrastructure & Resources](financial_infrastructure.md)**
